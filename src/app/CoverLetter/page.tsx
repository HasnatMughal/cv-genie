...
export default function CoverLetter(){
    ...
    return(
        ...
        <div className="min-h-screen w-full">
            ...
            <div className="flex flex-col gap-4 w-1/3 min-h-screen border shadow-md items-center">
            ...
            <form action="" className="flex flex-col justify-center p-4 items-center gap-4" onSubmit={(e) => 
                ...
                <div>
            <p>Job Title</p>
            <input type="text" value={jobTitle} onChange={(e:any) => setJobTitle(e.target.value)} className="w-72 p-2" />
                </div>
                <div>
            <p>Company</p>
            <input type="text" value={company} onChange={(e:any) => setCompany(e.target.value)} className="w-72 border-gray-50 border p-2" />
                </div>
                <div>
            <p>Your Background</p>
            <textarea name="" value={description} onChange={(e:any) => setDescription(e.target.value)} className="w-72 h-36 p-2 " id=""></textarea>
                </div>
            ...
            <div className="border p-4 w-2/3 flex flex-col min-h-screen">
               <h1 className="font-semibold text-xl"> Your Cover Letter:</h1>
                <div className="flex flex-col gap-4 items-center">
                <textarea name="" value={coverLetter} readOnly className="h-92 w-full" id=""></textarea>
